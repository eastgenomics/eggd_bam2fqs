...
main() {
    ...
    bedtools bamtofastq -i ${bam_name}_sorted_fix.bam -fq ${sample_id}_R1_bam2fqed.fastq -fq2 ${sample_id}_R2_bam2fqed.fastq
    gzip ${sample_id}_R*_bam2fqed.fastq

    # Upload the fastqs
    mkdir -p /home/dnanexus/out/fastq1
    mkdir -p /home/dnanexus/out/fastq2

    mv ${sample_id}_R1_bam2fqed.fastq.gz /home/dnanexus/out/fastq1/.
    mv ${sample_id}_R2_bam2fqed.fastq.gz /home/dnanexus/out/fastq2/.
